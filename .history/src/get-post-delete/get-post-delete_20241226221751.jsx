...
//   const [message, setMessage] = useState("");
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3000/api/getproduct") // Adjust the URL as per your backend
      .then((response) => {
  ...
  const handlesubmit = (e) => {
    ...
    axios
      .post("http://localhost:3000/api/postproduct", product) // Adjust the URL as per your backend
      .then((response) => {
